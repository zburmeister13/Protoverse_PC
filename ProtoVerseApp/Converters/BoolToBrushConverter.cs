...
{
    /// <summary>true -> brand accent green (on), false -> muted neutral gray (off).
    ...
    public class BoolToBrushConverter : IValueConverter
    {
        ...
        private static readonly Brush OffBrush = new SolidColorBrush(Color.FromRgb(0x9A, 0x9A, 0xA4));
